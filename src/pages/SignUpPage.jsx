  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 py-2 px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="mb-4">
          <button className="w-full flex items-center justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white hover:bg-gray-50 transition-colors">
