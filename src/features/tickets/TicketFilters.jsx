...
export default function TicketFilters() {
  ...
  return (
    <div className="flex w-full gap-4">
      <div className="h-10">
        <select className="h-full px-4 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-neutral-400">
